...
#
# state_path File.join(Rails.root, 'tmp/pids/puma.state')
...
# stdout_redirect File.join(Rails.root, 'log/stdout'), File.join(Rails.root, 'log/stderr')
...
# bind "tcp://0.0.0.0:#{Settings.application.port}"
